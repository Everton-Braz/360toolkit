...
def run_cli_mode():
    ...
    parser.add_argument("--stage2-format", default="png", help="Stage 2 output format")
    parser.add_argument("--use-gpu", action="store_true", default=True, help="Enable GPU")
    parser.add_argument("--verbose", action="store_true", help="Verbose logging")
    parser.add_argument("--stage2-input-dir", default=None, help="Input dir for Stage 2 (skip Stage 1)")
    parser.add_argument("--stage3-input-dir", default=None, help="Input dir for Stage 3 (skip Stage 2)")
