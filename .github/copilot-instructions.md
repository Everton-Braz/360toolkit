...
---------------
FULL WORKFLOW FOR TESTS WITH SCRIPTS:


EXTRACT EQUIRECTANGULAR IMAGES ✅
	2fps - 25 frames - 4K quality
MASK EQUIRECTANGULAR IMAGES (SKIP IF NO HUMANS OR ANIMAL..[CATEGORY CHOOSED]) ✅
ALIGN WITH GLOMAP (COLMAP IS FALLBACK, BUT GLOMAP IS DESIRED) ✅
EXTRACT THE POSITIONS OF THE GLOMAP/COLMAP OUTPUT ✅
SAVE THE METADATA AT SIDE FILES TO THE EQUIRECTANGULAR IMAGES ✅
TRANSFORM THE EQUIRECTANGULAR IMAGES TO PERSPECTIVES (E2P)✅
SAVE THE METADATA FROM EQUIRECTANGULAR IMAGES TO PERSPECTIVES (.XMP FILES FOR REALITYSCAN)
(FRAME_01.PNG --> FRAME_01_CAM_01.PNG ... 02 ... CAM_08.PNG)
MASK THE PERSPECTIVES.✅
EXPORT TO LITHCFELD STUDIO ✅
EXPORT TO REALITYSCAN ✅

------------------------------
GLOMAP/COLMAP:
EXTRACT FEATURES ✅
MATCH FEATURES (SEQUENTIAL) ✅
BUILD RECONSTRUCTION (SPARSE MODEL) ✅

*REALITY DOES NOT SUPORT EQUIRECTANGULAR IMAGES, THE IMAGES EQUIRECTANGULAR IS FOR LITHCFELD STUDIO, THE PERSPECTIVES ARE FOR REALITYSCAN* EACH ONE WITH THEIR RESPECTIVE MASKS, AND INFORMATIONS FROM THE CAMERAS... FROM GLOMAP/COLMAP.

INPUT: "G:\.shortcut-targets-by-id\12X9Cn_caDGuRMIO-hF6196FMdQyGNUDA\PROJETOS - CHICO SOMBRA\VIDEOS 360\VID_20251215_170106_00_211.insv"
...
OBJECTIVE: ACELERATE ALL PROCESS USING GPU WHERE IT IS POSSIBLE. I WANT TO SPHERESFM RUNNING TOGETHER WITH GLOMAP. 

SPHERESFM: SUPPORTS EQUIRECTANGULAR IMAGES.

GLOMAP: ALIGN THE IMAGES FASTER THAN COLMAP USING GPU.
...
SPLITED IMAGES IS FOR REALITYSCAN
EQUIRECTANGULAR IMAGES IS FOR LITHCFELD STUDIO

DO NOT RECOMEDN FOR ME, SPLIT IMAGES, I WANT THE EQUIRECTANGULAR IMAGES ALSO. CONTINUE TO PROVIDE BOTH OUTPUTS.